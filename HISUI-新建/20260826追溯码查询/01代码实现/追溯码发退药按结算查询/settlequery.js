/**
 * 模块:    发退药按结算日期扫码上传查询(独立页面)
 * 编写日期: 2025-08-18
 * 编写人:  chengshuo
 * 说明:    固定按结算日期查询,复用原有查询 PHA.DTC.Query.DispScanSettle.GetSettleScanInfo
 */
...
function InitGridInsu() {
    ...
    var dataGridOption = {
        url: $URL,
        queryParams: {
            ClassName: "PHA.DTC.Query.DispScanSettle",
            QueryName: "GetSettleScanInfo"
        },
