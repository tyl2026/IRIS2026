...
async def main():
    ...
    from submit_log import get_pending_weekly, mark_weekly_done, is_weekly_done
    ...
    if not weeks:
        print("No weeks found for last month!")
        return
    ...
    async with async_playwright() as p:
        ...
        if ok > 0:
            print(f"Log saved: {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'submit_log.json')}")
